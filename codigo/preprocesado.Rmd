...
```{r}
fechas_id <- seq(as.Date("2024-04-19"), as.Date("2024-10-01	"), by = "day")
...
fecha_inicio <- as.Date("2024-04-19")
...
for (fecha in fechas) {
  ...
  sensoro1 <- bind_rows(sensoro1, datos_temp)
  
  # Eliminar el archivo descargado para evitar acumulación
  file.remove(destino)
}

# Eliminar la primera fila si es basura
primera_fila_sensoro <- sensoro1[1, ]
sensoro1 <- sensoro1[-1, ]
...
```{r}
# Definir el rango de fechas
fecha_inicio <- as.Date("2025-02-11")
...
fechas_a_eliminar <- as.Date(c("2024-04-19", "2024-05-01", "2024-06-01", "2024-06-20",
                               "2024-07-29", "2024-07-30", "2024-08-26", "2024-09-27", "2024-09-05"))
